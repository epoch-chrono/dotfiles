...
# ─────────────────────────────────────────────────────────────────────────────
# Limpa LDFLAGS, CPPFLAGS e PKG_CONFIG_PATH setados por fn-brew-compile-env ou
# fn-brew-compile-with. Usar quando terminou de compilar e quer voltar ao
...
function fn-brew-compile-env-off --description "Limpa LDFLAGS/CPPFLAGS/PKG_CONFIG_PATH setados por fn-brew-compile-env*"
    set -e LDFLAGS
    set -e CPPFLAGS
